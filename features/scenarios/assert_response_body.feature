Feature: Assert Response Body
    ...
    Scenario: Assert Response Body Specific Key
        ...
        And the JSON response should have "$.job" with the text "leader"
        And the JSON response should have "$.pocket[2].wallet" with the text "50000"
    ...
    Scenario: Assert Response Body Length
        ...
        Then the response status should be "200"
        And show me the response
        And the JSON response should have "$.data..id" with a length of 10